...
function build_stage2 {
  ...
  if [ "$CHECK_LIBCXX" != "0" -a \
    ...
    sanitizer_cflags="$sanitizer_cflags -nostdinc++ -isystem ${ROOT}/${libcxx_build_dir}/projects/libcxx/include -isystem ${ROOT}/${libcxx_build_dir}/projects/libcxx/include/c++/v1"
