...
# Cross builders.
    ...
    'factory' : UnifiedTreeBuilder.getCmakeExBuildFactory(
                    ...
                    cmake_definitions = {
                        ...
                        "TOOLCHAIN_TARGET_SYSROOTFS"    : util.Interpolate("%(prop:sysroots)s/armv7-linux-gnueabihf-release"),
    ...
    'factory' : UnifiedTreeBuilder.getCmakeExBuildFactory(
                    ...
                    cmake_definitions = {
                        ...
                        "TOOLCHAIN_TARGET_SYSROOTFS"    : util.Interpolate("%(prop:sysroots)s/aarch64-linux-gnu-release"),
                        "REMOTE_TEST_HOST"              : util.Interpolate("%(prop:remote_test_host_rel)s"),
                        "REMOTE_TEST_USER"              : util.Interpolate("%(prop:remote_test_user_rel)s"),
                        "ZLIB_ROOT"                     : util.Interpolate("%(prop:sysroots)s/zlib-win32"),
                        "CMAKE_CXX_FLAGS"               : "-D__OPTIMIZE__",
