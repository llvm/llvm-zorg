...
def _get_polly_builders():
    return [
        ...
        {'name': "perf-x86_64-penryn-O3-polly-scev-codegen-isl-fast",
         'slavenames':["pollyperf10"],
         'builddir': "perf-x86_64-penryn-O3-polly-scev-codegen-isl-fast",
         'factory': PollyBuilder.getPollyLNTFactory(triple="x86_64-pc-linux-gnu",
                                                    nt_flags=['--multisample=1', '--mllvm=-polly', '--mllvm=-polly-codegen-scev', '--mllvm=-polly-code-generator=isl', '-j16' ],
                                                    reportBuildslave=False,
                                                    package_cache="http://parkas1.inria.fr/packages",
                                                    submitURL='http://llvm.org/perf/submitRun',
                                                    testerName='x86_64-penryn-O3-polly-scev')},

        {'name': "perf-x86_64-penryn-O3-polly-scev-parallel-codegen-isl-fast",
         'slavenames':["pollyperf6"],
         'builddir': "perf-x86_64-penryn-O3-polly-scev-parallel-codegen-isl-fast",
         'factory': PollyBuilder.getPollyLNTFactory(triple="x86_64-pc-linux-gnu",
        ...
        {'name': "perf-x86_64-penryn-O3-polly-scev-codegen-cloog-fast",
         ...
         'factory': PollyBuilder.getPollyLNTFactory(triple="x86_64-pc-linux-gnu",
                                                    nt_flags=['--multisample=1', '--mllvm=-polly', '--mllvm=-polly-code-generator=cloog', '-j16', '--mllvm=-polly-codegen-scev=true'],
                                                    reportBuildslave=False,
                                                    package_cache="http://parkas1.inria.fr/packages",
                                                    submitURL='http://llvm.org/perf/submitRun',
        ...
        {'name': "perf-x86_64-penryn-O3-polly-detect-scev",
         'slavenames':["pollyperf14"],
         'builddir':"perf-x86_64-penryn-O3-polly-detect-scev",
         'factory': PollyBuilder.getPollyLNTFactory(triple="x86_64-pc-linux-gnu",
                                                    nt_flags=['--multisample=10', '--mllvm=-polly', '--mllvm=-polly-code-generator=none', '--mllvm=-polly-optimizer=none', '--mllvm=-polly-run-dce=false', '--mllvm=-polly-codegen-scev=true', '--rerun'],
                                                    reportBuildslave=False,
                                                    package_cache="http://parkas1.inria.fr/packages",
                                                    submitURL='http://llvm.org/perf/submitRun',
                                                    testerName='x86_64-penryn-O3-polly-detect-scev')},

        {'name': "perf-x86_64-penryn-O3-polly-codegen-isl",
         'slavenames':["pollyperf7"],
         'builddir':"perf-x86_64-penryn-O3-polly-codegen-isl",
         'factory': PollyBuilder.getPollyLNTFactory(triple="x86_64-pc-linux-gnu",
                                                    nt_flags=['--multisample=10', '--mllvm=-polly', '--mllvm=-polly-code-generator=isl', '--mllvm=-polly-codegen-scev=false', '--rerun'],
                                                    reportBuildslave=False,
                                                    package_cache="http://parkas1.inria.fr/packages",
                                                    submitURL='http://llvm.org/perf/submitRun',
