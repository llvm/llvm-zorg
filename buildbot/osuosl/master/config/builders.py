...
def _get_polly_builders():
    return [
        ...
        {'name': "perf-x86_64-penryn-O3-polly-before-vectorizer",
         ...
         'factory': PollyBuilder.getPollyLNTFactory(triple="x86_64-pc-linux-gnu",
                                                    #nt_flags=['--multisample=10', '--mllvm=-polly', '--rerun'],
                                                    nt_flags=['--multisample=10', '--mllvm=-polly', '--mllvm=-polly-position=before-vectorizer', '--mllvm=-polly-enable-optree', '--mllvm=-polly-enable-delicm', '--mllvm=-polly-enable-simplify' ],
                                                    reportBuildslave=False,
                                                    package_cache="http://parkas1.inria.fr/packages",
                                                    submitURL=['http://gcc12.fsffrance.org:8808/submitRun','http://lnt.llvm.org/submitRun'],
        ...
        {'name': "perf-x86_64-penryn-O3-polly-before-vectorizer-unprofitable",
         ...
         'factory': PollyBuilder.getPollyLNTFactory(triple="x86_64-pc-linux-gnu",
                                                    nt_flags=['--multisample=1', '--mllvm=-polly', '--mllvm=-polly-position=before-vectorizer', '--mllvm=-polly-process-unprofitable', '-j16', '--mllvm=-polly-enable-optree', '--mllvm=-polly-enable-delicm', '--mllvm=-polly-enable-simplify' ],
                                                    reportBuildslave=False,
                                                    package_cache="http://parkas1.inria.fr/packages",
                                                    extra_cmake_args=['-DLLVM_ENABLE_ASSERTIONS=ON'],
                                                    submitURL=['http://gcc12.fsffrance.org:8808/submitRun','http://lnt.llvm.org/submitRun'],
