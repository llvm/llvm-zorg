...
def get_all():
    return [
        ...
        create_worker("linaro-clang-armv7-selfhost", properties={'jobs' : 32}, max_builds=1),
        ...
        create_worker("linaro-clang-armv7-selfhost-vfpv3", properties={'jobs' : 32}, max_builds=1),
        create_worker("linaro-clang-armv8-lld", properties={'jobs' : 32}, max_builds=1),
        ...
        create_worker("linaro-clang-aarch64-lld", properties={'jobs' : 32}, max_builds=1),
        create_worker("linaro-clang-aarch64-global-isel", properties={'jobs' : 32}, max_builds=1),
        create_worker("linaro-clang-aarch64-full", properties={'jobs' : 32}, max_builds=1),
