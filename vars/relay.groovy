    ...
    node(label: 'macos-x86_64') {
        stage('main') {
            ...
            withEnv([
                ...
                if (!artifact_url) {
                    artifact_url = "Green-Dragon-Testing/clang-stage1-RA/${branch}/latest"
                }

                if (!last_good_properties_url) {
                    last_good_properties_url = "Green-Dragon-Testing/clang-stage1-RA/${branch}/last_good_build.properties"
                }
